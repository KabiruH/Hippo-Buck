  ...
  return (
    <>
      <div className="space-y-3 md:space-y-4">
        ...
        <div 
          className="relative h-64 md:h-80 lg:h-96 rounded-lg overflow-hidden cursor-pointer group"
        ...
        {/* Thumbnail Grid - 2x2 on Mobile, 4 in a row on Desktop - All Clickable */}
